...
const BookRide = () => {
  ...
  const handleVehicleSelect = (type) => {
    const rideData = { pickup, destination, fare, vehicleType: type };
      ...
      <div className="relative z-10 flex-1 px-4 pb-8 space-y-4">
        ...
        <div className="bg-zinc-900 rounded-3xl border border-white/10 shadow-2xl overflow-visible">
          ...
          <div className="px-5 py-4 space-y-3">
            ...
            <div className="relative">
              ...
              >
                ...
                <button
                  ...
                  className={`flex-shrink-0 px-12 py-1 cursor-pointer  rounded-xl flex items-center justify-center transition active:scale-90 ${
                    locLoading
                ...
                >
                  ...
                  <span className="flex gap-2  justify-center items-center text-white">use current location <i className="ri-focus-3-line mt-1 text-amber-500 text-sm"></i></span>
                  )}
            ...
            {/* GPS HINT */}
            <p className="text-gray-600 text-xs px-1 flex items-center gap-1.5">
              <i className="ri-focus-3-line text-amber-500/60"></i>
              Tap <span className="text-amber-500/80"></span> to auto-fill
          ...
          <div className="animate-fadeIn">
            <div className="flex items-center justify-between mb-3 px-1">
              ...
              <button
                ...
                className="flex items-center gap-1 text-gray-500 hover:text-white text-sm transition"
              >
        ...
        {/* LOGIN PROMPT */}
        {/* {!user?._id && (
          <div className="bg-zinc-900 border border-amber-500/20 rounded-2xl p-5 text-center">
            ...
            <p className="text-white font-bold text-sm mb-1">Login to Book</p>
            <p className="text-gray-500 text-xs mb-4">
              Sign in to book your ride instantly
            </p>
            <button
              onClick={() => navigate("/login")}
              className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-white font-bold px-8 py-2.5 rounded-xl text-sm transition active:scale-95 shadow-lg shadow-amber-500/20"
            >
              Login / Sign Up
            </button>
          </div>
